    ...
    return (
      <>
        <form className="reserve-now">
          <h3 className="reserve-now-title">Rezerwuj pokój teraz!</h3>
          <span>
            <label htmlFor="arrivalDate">Przyjazd:</label>
            <br />
            <input
              style={
          ...
          <span>
            <label htmlFor="departureDate">Wyjazd:</label>
            <br />
            <input
              style={
                this.state.date2 > this.state.date
          ...
          {this.state.date2 > this.state.date ? (
            ...
            <div className="reserve-now-button2">Nieprawidłowe daty!</div>
          )}
        </form>
      </>
    );
